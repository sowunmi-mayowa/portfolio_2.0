          ...
          <div className="flex justify-between gap-6 md:items-center flex-col md:flex-row">
            <Reveal direction="left" delay={0.15} className="basis-1/2">
              <div>
                ...
                <p className="text-sm lg:text-md max-w-[300px] lg:max-w-sm py-4">
                  If you have any questions, proposals, or just want to have a
                  chat, feel free to get in touch.
                </p>
              </div>
              <Link
              ...
              <form onSubmit={handleSubmit(onSubmitHandler)}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="bg-[#fff] dark:bg-[#001122] w-full p-4 rounded-xl"
                    {...register("name")}
                  />
